...
export class figment extends Component {
  constructor(props) {
    ...
    this._onModelsClickStateCallback = this._onModelsClickStateCallback.bind(
      this,
    );
    this._onPortalsClickStateCallback = this._onPortalsClickStateCallback.bind(
      this,
    );
  }
  ...
  _onLoadCallback(uuid, loadState) {
    ...
    this.props.viroAppProps.loadingObjectCallback(uuid, loadState);
  }
  _onModelsClickStateCallback(uuid, clickState, itemType) {
    this.props.viroAppProps.clickStateCallback(uuid, clickState, itemType);
  }
  _onPortalsClickStateCallback(index, clickState, itemType) {
    this.props.viroAppProps.clickStateCallback(index, clickState, itemType);
  }
}
